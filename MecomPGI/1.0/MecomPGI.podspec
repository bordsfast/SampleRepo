#
#  Be sure to run `pod spec lint MecomPGI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "sample mecomPGI description with just a couple of lines"
  ...
  spec.source       = { :git => "https://github.com/geekhives/pgi-sdk-ios.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "MecomPGI/Classes/**/*.{h,m}"
  spec.exclude_files = "MecomPGI/Classes/Exclude"
